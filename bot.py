...
TOKEN = os.getenv("TOKEN")  # TOKEN dodajesz w Render w Environment Variables
...
async def addgroup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_id not in groups:
        ...
        save_groups(groups)
        await update.message.reply_text("✅ Ta grupa została dodana.")
    else:
        await update.message.reply_text("⚠️ Ta grupa już jest dodana.")
...
async def removegroup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_id in groups:
        ...
        await update.message.reply_text("Ta grupa nie była dodana.")
...
async def setmessage(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ Wiadomość została zmieniona.")
...
# -----------------------
# URUCHOMIENIE (Python 3.14 kompatybilne)
# -----------------------
